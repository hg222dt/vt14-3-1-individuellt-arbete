...
namespace LectureComments.App_Start
{
    public static class RouteConfig
    {
        ...
        {
            routes.MapPageRoute("LectureListing",   "forelasningar",                "~/Pages/RegLecturePages/Listing");
            ...
            routes.MapPageRoute("DeleteLecture",    "forelasning/{id}/radera",      "~/Pages/RegLecturePages/DeleteLecture.aspx");
            
            routes.MapPageRoute("Error",            "serverfel",                    "~/Pages/Shared/Error.aspx");
            
            routes.MapPageRoute("Default",          "",                             "~/Pages/RegLecturePages/Listing");
        }
    }
}